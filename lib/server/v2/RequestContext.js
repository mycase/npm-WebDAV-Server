...
exports.HTTPRequestContext = exports.ExternalRequestContext = exports.RequestContext = exports.DefaultRequestContextExternalOptions = exports.RequestContextHeaders = void 0;
...
var HTTPRequestContext = /** @class */ (function (_super) {
    ...
    HTTPRequestContext.encodeURL = function (url) {
        ...
        var rootPath = stringArray[0] + "//" + stringArray[2];
        var encodeUri = stringArray.splice(3).reduce(function (previousVal, currentVal, curIdx) {
